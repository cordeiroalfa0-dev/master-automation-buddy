...
const SERVICES: Record<string, ServiceData> = {
  "automacao-residencial": {
    ...
    longDesc: "Transforme sua residência em uma casa inteligente. Controle iluminação cênica, cortinas motorizadas, áudio multi-room, home cinema, som ambiente, aspiração central, climatização e segurança através do celular ou comandos de voz. Integração com Alexa, Google Home e Apple HomeKit.",
    img: resImg,
    features: ["Iluminação cênica programável", "Cortinas e persianas motorizadas", "Áudio multi-room (Sonos, B&O)", "Home cinema com áudio e vídeo imersivo", "Som ambiente integrado por cômodo", "Aspiração central embutida", "Climatização inteligente", "Cenas personalizadas (Bom dia, Cinema, Boa noite)", "Integração com assistentes de voz", "Controle por aplicativo dedicado", "Sensores de presença e luminosidade"],
    ...
    faq: [
      ...
      { question: "Vocês instalam home cinema e som ambiente?", answer: "Sim. Projetamos salas de home cinema com áudio e vídeo imersivo e som ambiente multi-room integrado ao sistema de automação da casa, além de aspiração central embutida na estrutura do imóvel." },
    ],
  },
  "automacao-predial": {
    title: "Automação Predial em Curitiba",
    shortDesc: "Gestão inteligente de edifícios e condomínios",
    longDesc: "Sistemas integrados de automação para edifícios residenciais, comerciais e condomínios. Reduza custos operacionais com gestão energética inteligente, controle de acessos automatizado, cabeamento estruturado, vídeo wall e monitoramento centralizado.",
    img: comImg,
    features: ["Controle de acesso veicular automatizado", "Catracas com biometria facial", "CFTV IP integrado", "Cabeamento estruturado para redes e telefonia", "Vídeo wall para recepção e salas de monitoramento", "Sistema de combate a incêndio integrado", "Iluminação automatizada de áreas comuns", "Gestão de elevadores e bombas", "Portaria remota 24h", "Dashboard de monitoramento centralizado"],
    ...
    faq: [
      ...
      { question: "Fazem cabeamento estruturado e vídeo wall?", answer: "Sim. Projetamos e instalamos cabeamento estruturado para redes e telefonia, vídeo wall para recepções e centrais de monitoramento, e sistemas de combate a incêndio integrados à automação predial." },
    ],
  },
  "automacao-industrial": {
    title: "Automação Industrial em Curitiba",
    shortDesc: "CLPs, SCADA, painéis elétricos e controle de processos",
    longDesc: "Soluções de automação industrial completas para indústrias em Curitiba e região. Programação de CLPs Siemens, Allen-Bradley e Omron. Painéis elétricos sob medida, supervisão SCADA, instrumentação e comissionamento, adequação às normas NR10 e NR12, inversores de frequência e integração com ERPs.",
    img: indImg,
    features: ["Programação de CLPs (Siemens, Allen-Bradley, Omron)", "Supervisão SCADA personalizada", "Montagem de painéis elétricos sob medida", "Instrumentação e comissionamento industrial", "Adequação às normas NR10 e NR12", "Inversores de frequência (WEG, ABB)", "Sistemas de partida suave", "Integração com ERPs e MES", "Manutenção preventiva e corretiva", "Retrofit industrial de máquinas antigas"],
    benefits: ["Aumento de produtividade", "Redução de paradas não planejadas", "Rastreabilidade da produção", "Eficiência energética industrial", "Conformidade com normas de segurança do trabalho"],
    faq: [
      ...
      { question: "Fazem adequação às normas NR10 e NR12?", answer: "Sim. Realizamos laudos e adequações de painéis e máquinas às normas NR10 (segurança em instalações elétricas) e NR12 (segurança em máquinas e equipamentos), além de instrumentação e comissionamento de novos processos." },
    ],
  },
