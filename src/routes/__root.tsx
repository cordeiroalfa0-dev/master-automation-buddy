...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Master Automação is a professional website designed for automated electrical services, optimized for traffic management." },
      { property: "og:description", content: "Master Automação is a professional website designed for automated electrical services, optimized for traffic management." },
      { name: "twitter:description", content: "Master Automação is a professional website designed for automated electrical services, optimized for traffic management." },
